...
class AttendanceRuleModel extends Model{
    ...
    protected $_validate = array(
        //迟到次数
        array('dept', 'require', '请选择部门', self::MUST_VALIDATE , 'regex', self::MODEL_BOTH),
...
//      array('email', '', '邮箱被占用', self::EXISTS_VALIDATE, 'unique', self::MODEL_BOTH),
        ...
        //上班时间
        array('firsttime', '/^(?:\d|[12]\d|25)$/', '上班时间请输入小于24', self::MUST_VALIDATE , 'regex', self::MODEL_BOTH),
//      array('mobile', '', '手机号被占用', self::EXISTS_VALIDATE, 'unique', self::MODEL_BOTH),

        //下班时间
        array('secondtime', '/^(?:\d|[12]\d|25)$/', '下班时间请输入小于24', self::MUST_VALIDATE , 'regex', self::MODEL_BOTH),
