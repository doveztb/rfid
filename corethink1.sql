...
CREATE TABLE `ct_attendance_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='考勤记录表';
...
INSERT INTO `ct_attendance_record` VALUES (1,5,3,1460855025,1460883825,1,1,1,1460855025),(2,5,3,1460509680,1460545680,1,0,1,1460509680),(3,9,1,1460509680,1460545680,1,0,1,1460509680),(4,5,3,1457744888,1457780888,1,1,1,1457744888);
...
CREATE TABLE `ct_attendance_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='考勤规则';
...
INSERT INTO `ct_attendance_rule` VALUES (1,1,NULL,8,18,10,1),(2,1,'客服',4,4,4,1);
...
CREATE TABLE `ct_company` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='子公司表';
...
INSERT INTO `ct_company` VALUES (1,'子公司A','人事,客服,技术,销售','郑州','13849171733',1),(3,'子公司B',NULL,'郑州','13849171733',1),(4,'子公司c','客服,人事,技术','东区','13849171733',1);
...
CREATE TABLE `ct_system_menu` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=125 DEFAULT CHARSET=utf8 COMMENT='后台菜单表';
...
INSERT INTO `ct_user` VALUES (1,NULL,NULL,0,'admin',NULL,NULL,'60d908217a487a048d81b3da0fc0ca64',1,0,0,0,0.00,'1',0,0,'','','','',60,1460903305,2130706433,2130706433,'admin',1438651748,1438651748,0,1),(3,1,NULL,1,'ztb','1611128494@qq.com','13849171733','fa4532a409a824ccf5f0bf8c767a4f8c',3,0,3,0,0.00,'0',0,0,'','','','',23,1460903379,2130706433,2130706433,'1',1456796953,1456796953,0,1),(4,3,'技术',1,'ztb001','13849171733@163.com','13849171744','1faf405dc098efb412c1d3e1651c4758',0,0,4,0,0.00,'0',0,0,'','','','',3,1460380195,2130706433,2130706433,'1',1459774991,1459774991,0,1),(5,3,'人事',1,'ztb01','13849171744@163.com','13849171755','1faf405dc098efb412c1d3e1651c4758',3,1,0,0,0.00,'0',0,0,'','','','',1,1460860107,2130706433,2130706433,'',1459839838,1459839838,0,1),(9,1,'人事',0,'ztb03','13849171777@163.com','13849171777','1faf405dc098efb412c1d3e1651c4758',0,0,0,0,0.00,'0',0,0,'','','','',0,0,0,2130706433,'',1459847283,1459847283,0,1),(11,1,'客服',0,'ztb04','13849171788@163.com','13849171788','1faf405dc098efb412c1d3e1651c4758',0,0,0,0,0.00,'0',0,0,'','','','',0,0,0,2130706433,'',1459847524,1459847524,0,1);
...
INSERT INTO `ct_user_group` VALUES (1,0,'管理员','','','',1426881003,1427552428,0,1),(3,1,'子公司管理员','fa fa-adjust','1,6,13,89,90,91,92,4,12,85,86,87,88,97,100,122,123,101,124,98,117,118,121,119,120,99,102,93,94,95,96,103,113,116,114,115',NULL,1459774470,1460903356,0,1);
